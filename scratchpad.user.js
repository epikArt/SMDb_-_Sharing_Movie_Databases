...
var sites = [
    ...
    new Site(
            'PrivateHD',
            'PRHD',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=privatehd.to',
    ...
    new Site(
            'SceneHD',
            'SHD',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=scenehd.org',
	...
	new Site(
            'HDBits',
            'HDBits',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=hdbits.org',
    ...
    new Site(
            'HD-Torrents',
            'HDTS',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=hd-torrents.org',
	...
	new Site(
            'HDTime',
            'HDTM',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=hdtime.org',
    ...
    new Site(
            'ToTheGlory',
            'TTG',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=totheglory.im',
    ...
    new Site(
            'HDSky',
            'HDS',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=hdsky.me',
    ...
    new Site(
            'HDHome',
            'HDH',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=hdbiger.org',
    ...
    new Site(
            'HDChina',
            'HDC',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=hdchina.org',
    ...
    new Site(
            'UHDBits',
            'UHD',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=uhdbits.org',
	...
	new Site(
            'Bj Share',
            'BjS',
            'https://bj-share.me/favicon.ico',
            'https://bj-share.me/torrents.php?searchstr=%q',
            '.group_torrent',
            'h2:contains(Your search did not match anything.)',
            '.submit',
            imdb.getTitle(true, true)
    ...
    new Site(
            'Acid-Lounge',
            'ACID',
            'http://www.acid-lounge.org.uk/themes/acid/favicon.ico',
    ...
    new Site(
            'HDme',
            'HDME',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=hdme.eu',
    ...
    new Site(
            'BlueBird',
            'BLUEBIRD',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=bluebird-hd.org',
	...
	new Site(
            'HD4Free',
            'HD4F',
            'http://i.imgur.com/3gPbiUa.png',
            'https://hd4free.xyz/browse.php?search=%q&searchin=descr&incldead=0',
            null,
            null,
            '.btn-clean',
            imdb.id
    ...
    new Site(
            'Hd-BitsCom',
            'HDBc',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=www.hd-bits.com',
    ...
    new Site(
            'FunFile',
            'FF',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=www.funfile.org',
    ...
    new Site(
            'PreToMe',
            'PTM',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=pretome.info',
	...
	new Site(
            'RevolutionTT',
            'RevTT',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=revolutiontt.me',
    ...
    new Site(
            'TorrentBytes',
            'TBYS',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=www.torrentbytes.net',
	...
	new Site(
            'nCore',
            'NCR',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=ncore.cc',
	...
	new Site(
            'IPTorrents',
            'IPT',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=www.iptorrents.com',
    ...
    new Site(
      ...
      new Site(
            ...
            'BitvaulTtorrent',
            'bV',
            'https://www.bitvaulttorrent.com/favicon.ico',
	...
	new Site(
            'RoDVD-Net',
            'RODVD',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=rodvd.net',
    ...
    new Site(
            'Insane Tracker',
            'iNSANE',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=newinsane.info',
    ...
    new Site(
            'KinozalTV',
            'KTB',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=kinozal.tv',
    ...
    new Site(
            'Rarbg',
            'RBG',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=rarbg.to',
	...
	new Site(
            'MkvCage',
            'mkvc',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=www.mkvcage.com',
    ...
    new Site(
            'Rarelust',
            'RL',
            'http://s2.googleusercontent.com/s2/favicons?domain_url=rarelust.com',
    ...
    new Site(
            ...
            'https://www.idope.se/torrent-list/%q',
            'h1:contains(tt)',
            'h1:contains(Nothing Found)',
            null,
            imdb.getTitle(true, true)
...
$(document).ready(function() {
  ...
  for (var i = 0; i < miniSites.length; i++) {
    ...
    $('#mini-container').append('<a href="' + miniSite.getSearchUrl() +
      '" target="miniTab"><img src="' + miniSite.icon + '" style="width: 16px; height: 16px; margin: 2px;" alt="' + miniSite.name + '" title="' + miniSite.name + '"></a>');
  }
  ...
  for (var i = 0; i < sites.length; i++) {
    ...
    if (site.isEnabled()) {
      $('#platypus-container').append('<a href="' + site.getSearchUrl() + '" target="platypusTab"><img id="' + site.getImageId() + '" class="smdb-search-icon" src="' + status.none.img + '" style="width: 20px; height: 20px; background: url(' + site.icon + '); background-repeat: no-repeat; margin: 2px;" alt="' + site.abbreviation + '" title="' + site.name + '"></a>');
    }
